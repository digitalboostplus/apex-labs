...
**Project:** Peptides Launch
**Generated:** 2026-01-21 12:54:04
...
|------|-----|--------------|
| Primary | `#FF4D4D` | `--color-primary` |
| Secondary | `#4D94FF` | `--color-secondary` |
| CTA/Accent | `#00E676` | `--color-cta` |
| Background | `#F5F5F7` | `--color-background` |
| Text | `#1C1C1E` | `--color-text` |

**Color Notes:** Biological red/blue + Clinical white
